...
RSpec.describe EventTimesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all event_times as @event_times" do
      ...
      expect(assigns(:event_times)).to eq([event_time])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new event_time as @event_time" do
      ...
      expect(assigns(:event_time)).to be_a_new(EventTime)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created event_time as @event_time" do
        post :create, {:event_time => valid_attributes}, valid_session
        expect(assigns(:event_time)).to be_a(EventTime)
        expect(assigns(:event_time)).to be_persisted
      end

      it "redirects to the created event_time" do
        post :create, {:event_time => valid_attributes}, valid_session
        expect(response).to redirect_to(EventTime.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved event_time as @event_time" do
        post :create, {:event_time => invalid_attributes}, valid_session
        expect(assigns(:event_time)).to be_a_new(EventTime)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested event_time" do
        event_time = EventTime.create! valid_attributes
        put :update, {:id => event_time.to_param, :event_time => new_attributes}, valid_session
        event_time.reload
      ...
      it "redirects to the event_time" do
        event_time = EventTime.create! valid_attributes
        put :update, {:id => event_time.to_param, :event_time => valid_attributes}, valid_session
        expect(response).to redirect_to(event_time)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the event_time as @event_time" do
        event_time = EventTime.create! valid_attributes
        put :update, {:id => event_time.to_param, :event_time => invalid_attributes}, valid_session
        expect(assigns(:event_time)).to eq(event_time)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the event_times list" do
      event_time = EventTime.create! valid_attributes
      delete :destroy, {:id => event_time.to_param}, valid_session
      expect(response).to redirect_to(event_times_url)
    end
  end
